...
class Ui_Word2VecDialog(object):
    def setupUi(self, Word2VecDialog):
        ...
        Word2VecDialog.resize(1043, 580)
        ...
        self.tsneTSVDBtn = QtWidgets.QPushButton(self.visualizeGBox)
        self.tsneTSVDBtn.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tsneTSVDBtn.sizePolicy().hasHeightForWidth())
        self.tsneTSVDBtn.setSizePolicy(sizePolicy)
        self.tsneTSVDBtn.setMinimumSize(QtCore.QSize(100, 30))
        self.tsneTSVDBtn.setObjectName("tsneTSVDBtn")
        self.btnHLayout.addWidget(self.tsneTSVDBtn)
        self.tsnePCABtn = QtWidgets.QPushButton(self.visualizeGBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tsnePCABtn.sizePolicy().hasHeightForWidth())
        self.tsnePCABtn.setSizePolicy(sizePolicy)
        self.tsnePCABtn.setMinimumSize(QtCore.QSize(161, 30))
        self.tsnePCABtn.setObjectName("tsnePCABtn")
        self.btnHLayout.addWidget(self.tsnePCABtn)
        self.tsvdBtn = QtWidgets.QPushButton(self.visualizeGBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tsvdBtn.sizePolicy().hasHeightForWidth())
        self.tsvdBtn.setSizePolicy(sizePolicy)
        self.tsvdBtn.setMinimumSize(QtCore.QSize(106, 30))
        self.tsvdBtn.setObjectName("tsvdBtn")
        self.btnHLayout.addWidget(self.tsvdBtn)
        self.pcaBtn = QtWidgets.QPushButton(self.visualizeGBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pcaBtn.sizePolicy().hasHeightForWidth())
        self.pcaBtn.setSizePolicy(sizePolicy)
        self.pcaBtn.setMinimumSize(QtCore.QSize(95, 30))
        self.pcaBtn.setObjectName("pcaBtn")
        self.btnHLayout.addWidget(self.pcaBtn)
        ...
        self.showOnPlotBtn = QtWidgets.QPushButton(self.searchQueryGBox)
        self.showOnPlotBtn.setMinimumSize(QtCore.QSize(0, 30))
        self.showOnPlotBtn.setObjectName("showOnPlotBtn")
        self.searchQueryHLayout.addWidget(self.showOnPlotBtn)
    ...
    def retranslateUi(self, Word2VecDialog):
        ...
        self.visualizeGBox.setTitle(_translate("Word2VecDialog", "Визуализировать алгоритмами"))
        self.tsneTSVDBtn.setText(_translate("Word2VecDialog", "PCA и t-SNE"))
        self.tsnePCABtn.setText(_translate("Word2VecDialog", " TruncatedSVD и t-SNE"))
        self.tsvdBtn.setText(_translate("Word2VecDialog", " TruncatedSVD"))
        self.pcaBtn.setText(_translate("Word2VecDialog", "PCA"))
        ...
        self.showOnPlotBtn.setText(_translate("Word2VecDialog", "Показать на графике"))
